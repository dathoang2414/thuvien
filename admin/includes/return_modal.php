    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Trả sách</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="return_add.php">
          		  <div class="form-group">
                  	<label for="student" class="col-sm-3 control-label">Mã SV</label>
                  	...
                  	<div class="col-sm-9">
                       ...
                       <select class="form-control" name="student" id="student" required="">
                        <option value="" selected="" disabled=""> Vui Lòng Chọn Sinh Viên Ở Đây.</option>
                        <?php  
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      ...
                      <select class="form-control" name="isbn[]" >
                        <option value="" selected="" disabled=""> Vui Lòng đặt sách Tại Đây.</option>
                        <?php  
                            $books = "SELECT * FROM books where status = 1 order by title asc ";
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                      <button class="btn btn-primary btn-xs btn-flat" id="append"><i class="fa fa-plus"></i> Trường sách</button>
                    </div>
                </div>
          	</div>
