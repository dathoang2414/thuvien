    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Mượn sách</b></h4>
          	</div>
            	...
            	<form class="form-horizontal" method="POST" action="borrow_add.php">
          		  <div class="form-group">
                      ...
                      <select class="form-control" name="student" id="student" required="">
                        <option value="" selected="" disabled="">Chọn Sinh Viên Tại Đây.</option>
                        <?php  
                    ...
                    <div class="col-sm-9">
                      <!-- <input type="text" class="form-control" id="isbn" name="isbn[]" required> -->
                       <select class="form-control" name="isbn[]" >
                        <option value="" selected="" disabled=""> Chọn sách tại đây.</option>
                        <?php  
