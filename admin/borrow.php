        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Mượn</a>
            </div>
            <div class="box-body">
                  ...
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      if($row['barstat']){
                        ...
                        $status = '<span class="label label-danger">Không trả lại</span>';
                      }
                      echo "
                        <tr>
                          <td class='hidden'></td>
...
$(function(){
  $(document).on('click', '#append', function(e){
    ...
    // );
    $('#append-div').append(
      '<div class="form-group"><label for="" class="col-sm-3 control-label">Mã sách</label><div class="col-sm-9">'+_tmp.html()+'</div></div>'
    );
    rem_select()
  });
});
